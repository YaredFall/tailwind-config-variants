...
import { cx } from "./cx";
import type { RecipeVariant, SlotRecipeConfig, SlotVariantsDefinition, SVA } from "./types";
...
export function sva<S extends string, SV extends SlotVariantsDefinition<S>>({
    ...
    variants = {} as SV,
    defaultVariants = {},
}: SlotRecipeConfig<S, SV>) {
    const sva = (props: RecipeVariant<SV> = {}) => {
