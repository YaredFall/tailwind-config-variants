...
export function sva<S extends string, SV extends SlotVariantsDefinition<S>>({
    ...
    svaFunction.variantKeys = getVariantKeys(variants);
    svaFunction.variantMap = getVariantMap(variants);

    svaFunction.splitProps = createSplitProps(variants);
